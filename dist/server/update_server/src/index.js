...
var watchers = [];
var server = new WebSocket.Server({ port: port, noServer: true });
server.on("connection", function (client) {
    client.on('message', function (data) {
        if (data === "upgrade") {
            ...
            if (message.type === 2)
                server.clients.forEach(function (i) { return i.send(data); });
            else
                watchers.forEach(function (i) { return i.send(data); });
        }
    });
    client.on('close', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                index = watchers.findIndex(function (i) { return i === client; });
                if (index > -1)
