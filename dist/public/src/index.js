...
window.addEventListener("load", function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, http_1.default("/api/friends", http_1.Result.text)];
                case 1:
                    friends = _a.sent();
                    ...
                    document.querySelector("#befriend-btn").addEventListener("click", function () {
                        dialogues_1.default.friendSearch.show();
                    });
                    window.addEventListener("hashchange", function () {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, navigate_1.default(window.location.hash)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    StateManager.on('openChat', function (state) {
